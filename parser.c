...
static const char *const yytname[] =
{
  ...
  "MOD_ASGN", "PL_ASGN", "M_ASGN", "CHAR", "SHORT", "INT", "LONG",
  "SIGNED", "UNSIGNED", "FLOAT", "DOUBLE", "VOID", "CASE", "DEFAULT", "IF",
  "ELSE", "SWITCH", "WHILE", "DO", "FOR", "GOTO", "CONTINUE", "BREAK",
  "RETURN", "ID", "FLOAT_VAL", "INT_VAL", "STR_VAL", "CHAR_VAL", "SIZEOF",
  "PLUS", "MINUS", "TIMES", "OVER", "PERCENT", "LPAR", "RPAR", "LCURLY",
  "RCURLY", "LBRAC", "RBRAC", "SEMI", "COMMA", "AMPER", "COLON", "UMINUS",
  ...
  "abstract_declarator", "initializer", "initializer_list", "statement",
...
{
      -1,    51,   176,    52,    53,    24,   121,   122,     6,    92,
